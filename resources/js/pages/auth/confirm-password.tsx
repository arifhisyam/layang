...
export default function ConfirmPassword() {
    ...
    return (
        <>
            <Head title="Konfirmasi Kata Sandi — Layang-Layang Event 2026" />
            <style>{`
                        ...
                        <div style={{ padding: 'clamp(32px, 5vw, 44px) clamp(28px, 5vw, 44px)' }}>
                            ...
                            <div style={{ marginBottom: 32 }}>
                                <h1 style={{
                                    ...
                                    🔒 <span className="gradient-text">Konfirmasi Kata Sandi</span>
                                </h1>
                                <p style={{ fontSize: 13.5, color: '#2C4A6A', fontFamily: "'Open Sans', sans-serif", lineHeight: 1.65 }}>
                                    Ini adalah area aman. Konfirmasi kata sandimu sebelum melanjutkan.
                                </p>
                            </div>
                                            ...
                                            <div style={{
                                                ...
                                                <PasswordInput
                                                    ...
                                                    style={{
                                                        ...
                                                        padding: '14px 16px', fontSize: 14.5, color: '#0B1F3A',
