...
export default function ResetPassword({ token, email }: Props) {
    ...
    return (
        <>
            <Head title="Reset Kata Sandi — Layang-Layang Event 2026" />
            <style>{`
                        ...
                        <div style={{ padding: 'clamp(32px, 5vw, 44px) clamp(28px, 5vw, 44px)' }}>
                            ...
                            <div style={{ marginBottom: 32 }}>
                                <h1 style={{
                                    ...
                                    <span className="gradient-text">Reset Kata Sandi</span> 🔒
                                </h1>
                                <p style={{ fontSize: 13.5, color: '#2C4A6A', fontFamily: "'Open Sans', sans-serif", lineHeight: 1.65 }}>
                                    Masukkan kata sandi baru di bawah ini untuk melanjutkan.
                                </p>
                            </div>
                                ...
                                {({ processing, errors }) => (
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                                            ...
                                            <div style={{
                                                ...
                                                <Input
                                                    ...
                                                    style={{
                                                        ...
                                                        color: '#4A6A8A', fontFamily: "'Open Sans', sans-serif",
                                                        outline: 'none', width: '100%', cursor: 'not-allowed',
                                                    }}
                                                />
                                            </div>
                                        ...
                                        <button
                                            ...
                                            style={{
                                                width: '100%', border: 'none', marginTop: 8,
