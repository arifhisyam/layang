...
import { IconShield, IconKey, IconRefresh } from '@tabler/icons-react';
...
export default function TwoFactorChallenge() {
    ...
    return (
        <>
            <Head title="Two-factor authentication — Layang-Layang Event 2026" />
            <style>{`
                ...
                *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
                ...
                /* OTP slot override to match theme */
                [data-input-otp] input { font-family: 'Montserrat', sans-serif !important; }
            `}</style>
                        ...
                        <div style={{ padding: 'clamp(32px, 5vw, 44px) clamp(28px, 5vw, 44px)' }}>
                            ...
                            <div style={{ marginBottom: 32 }}>
                                <h1 style={{
                                    ...
                                    {showRecoveryInput ? <IconKey size={24} color="#0EA5E9" /> : <IconShield size={24} color="#0EA5E9" />}
                                    <span className="gradient-text">
                                        {showRecoveryInput ? 'Kode Pemulihan' : 'Autentikasi Dua Faktor'}
                                    </span>
                                </h1>
                                <p style={{ fontSize: 13.5, color: '#2C4A6A', fontFamily: "'Open Sans', sans-serif", lineHeight: 1.65 }}>
                                    {showRecoveryInput
                                        ? 'Konfirmasi akses dengan salah satu kode pemulihan daruratmu.'
                                        : 'Masukkan kode autentikasi dari aplikasi authenticator-mu.'
                                    }
                                </p>
                            </div>
                                ...
                                {({ errors, processing, clearErrors }) => (
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                                        ...
                                        <div style={{ textAlign: 'center' }}>
                                            <span style={{ fontSize: 13, color: '#4A6A8A', fontFamily: "'Open Sans', sans-serif" }}>atau </span>
                                            <button
                                                type="button"
                                            ...
                                            >
                                                <IconRefresh size={13} />
                                                {showRecoveryInput ? 'gunakan kode autentikasi' : 'gunakan kode pemulihan'}
                                            </button>
                                        </div>
                                    </div>
                                )}
