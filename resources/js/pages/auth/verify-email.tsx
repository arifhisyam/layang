...
import { IconCircleCheck, IconMail, IconLogout } from '@tabler/icons-react';
...
export default function VerifyEmail({ status }: { status?: string }) {
    ...
    return (
        <>
            <Head title="Verifikasi Email — Layang-Layang Event 2026" />
            <style>{`
                        ...
                        <div style={{ padding: 'clamp(32px, 5vw, 44px) clamp(28px, 5vw, 44px)' }}>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 28 }}>
                                <div style={{ position: 'relative' }}>
                                    ...
                                    <div style={{
                                        ...
                                        background: 'linear-gradient(135deg, #0EA5E9, #1565C0)',
                                        display: 'flex', alignItems: 'center', justifyContent: 'center',
                                        boxShadow: '0 12px 36px rgba(14,165,233,0.42)',
                                        position: 'relative',
                                    }}>
                                        <IconMail size={32} color="#fff" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style={{ marginBottom: 28, textAlign: 'center' }}>
                                <h1 style={{
                                    ...
                                    <span className="gradient-text">Verifikasi Email</span>
                                </h1>
                                <p style={{ fontSize: 13.5, color: '#2C4A6A', fontFamily: "'Open Sans', sans-serif", lineHeight: 1.65 }}>
                                    Klik tautan verifikasi yang sudah kami kirimkan ke alamat emailmu untuk mengaktifkan akun.
                                </p>
                            </div>
                            ...
                            {status === 'verification-link-sent' && (
                                <div style={{
                                    ...
                                    Tautan verifikasi baru telah dikirimkan ke emailmu.
                                </div>
                            )}
